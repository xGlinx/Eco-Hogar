...
<span>RUC: </span><input type="text" style="width:265px; height:30px;" name="" required/><br>
...
<span> Telefono de contacto : </span><input type="text" style="width:265px; height:30px;" name="cperson" /><br>
