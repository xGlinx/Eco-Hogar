...
<option></option>
	...
	?>	
		<option value="<?php echo $row['product_id'];?>"><?php echo $row['product_code']; ?> - <?php echo $row['gen_name']; ?> - <?php echo $row['product_name']; ?> | Precio: <?php echo $row['price']; ?></option>
	<?php
				}
			?>
</select>
...
<input type="float" name="discount" value="" min="0" autocomplete="off" placeholder="Descuento S/." style="width: 107px; height:30px; padding-top:4px; padding-bottom: 4px; margin-right: 4px; font-size:15px;" />
